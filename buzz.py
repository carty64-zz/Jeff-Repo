...
led_pin = 16 # Choose any GPIO pin
buzzer_pin = 12 # Choose any GPIO pin (will use software PWM)
    ...
    while True:
        ...
        if "pts" in output:
            if current_status == False:
                ...
                buzzer.ChangeFrequency(a) # playing an E
                time.sleep(0.25) # for 1/4 second
                buzzer.ChangeFrequency(b) # playing a G
                time.sleep(0.25) # for 1/4 second
               # buzzer.ChangeFrequency(g) # playing a high C
               # time.sleep(0.25) # for 1/2 second
