...
url = 'http://www.basketball-reference.com/players/h/haywago01.html'
...
table = soup.find('div', attrs={'class':'table_container','id': 'div_totals'})
...
if sc.rtm_connect():
  while(1):
    ...
    if len(message) > 0 and message[0]['type'] == 'message':
      if '@U0X540ZK2' and 'hi' in message[0]['text'].lower():
